...
\begin{itemize}
    ...
    \comment{Carmelo}{Maybe there's an errore here. Should the \texttt{key\_count} field must be consistent with the number of ``fields'' or ``bytes'' of the update-scope?}
